Config = {
    ...
    button = {'Basın ~INPUT_CONTEXT~ Arabanizi Yıkamak icin ~g~$%s~s~', 0, 38},-- First entry is the message, second ectry is pad index, third entry is control key.
    only_dirty_vehicles = false,--This is lock car washed to dirty vehicles only (GetVehicleDirtLevel must be above 0.1)
    cost = 20,--How much it costs for a car wash
    ...
    locations = {
        {
            name = 'Çilek Oto Yıkama',--Name of the carwash (Only used for blips)
        ...
        {
            name = 'Küçük Seul Araba Yıkama',--Name of the carwash (Only used for blips)
            location = vector3(-699.84, -934.0, 19.0),--Location for the carwash
            use_props = true,--Should we spawn the props? Some locations it will look out of place to have the props.
            show_blip = true,--Should this carwash create a blip?
        },
        {
            name = 'Paleto Oto Yıkama',--Name of the carwash (Only used for blips)
