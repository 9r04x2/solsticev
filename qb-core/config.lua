...
QBConfig.MaxPlayers = GetConvarInt('sv_maxclients', 256) -- Gets max players from config file, default 48
QBConfig.DefaultSpawn = vector4(-1035.71, -2731.87, 12.86, 0.0)
QBConfig.UpdateInterval = 5                             -- how often to update player data in minutes
QBConfig.StatusInterval = 1000                          -- how often to check hunger/thirst status in milliseconds

QBConfig.Money = {}
QBConfig.Money.MoneyTypes = { cash = 100, bank = 1000, crypto = 0 } -- type = startamount - Add or remove money types for your server (for ex. blackmoney = 0), remember once added it will not be removed from the database!
...
QBConfig.Player = {}
QBConfig.Player.HungerRate = 2.9-- Rate at which hunger goes down.
