...
Config.Helicopter = "toleair" -- Helicopter model that players with the ambulance job can use
Config.BillCost = 1200 -- Price that players are charged for using the hospital check-in system
...
Config.AIHealTimer = 25 -- How long it will take to be healed after checking in, in seconds
...
Config.Locations = { -- Edit the various interaction points for players or create new ones
    ["checking"] = {
	    [1] = vector4(1144.47, -1539.77, 35.03, 278.85),
	    -- [2] = vector3(-254.54, 6331.78, 32.43), -- paleto
    },
    ["duty"] = {
        [1] = vector3(307.43, -595.31, 42.7),
    },
    ["vehicle"] = {
        -- [1] = vector4(281.36, -604.94, 43.12, 91.15),
        -- [2] = vector4(-234.28, 6329.16, 32.15, 222.5),
    },
    ["helicopter"] = {
        -- [1] = vector4(-1028.95, -425.973, 65.059, 29.65),
    },
    ["armory"] = {
    ...
    ["roof"] = {
        -- [1] = vector4(338.5242, -583.7899, 74.1617, 249.4805),
    },
    ["main"] = {
        -- [1] = vector4(332.4421, -595.5790, 43.2841, 252.1574),
    },
    ["altkat"] = {
        -- [1] = vector4(332.4421, -595.5790, 43.2841, 252.1574),
    },
    ...
    ["beds"] = {
        [1] = {coords = vector4(1124.76, -1563.14, 36.10, 0.00), taken = false, model = 256650529 },
        [2] = {coords = vector4(1121.34, -1563.12, 36.10, 0.00), taken = false, model = 256650529 },
        [3] = {coords = vector4(1117.88, -1563.13, 36.10, 0.00), taken = false, model = 256650529 },
        [4] = {coords = vector4(1117.84, -1554.58, 36.10, 180.00), taken = false, model = 256650529 },
        [5] = {coords = vector4(1121.36, -1554.54, 36.10, 180.00), taken = false, model = 256650529 },
        [6] = {coords = vector4(1124.83, -1554.57, 36.10, 180.00), taken = false, model = 256650529 },
    },
    ["jailbeds"] = {
        [1] = {coords = vector4(1124.76, -1563.14, 36.10, 0.00), taken = false, model = 256650529 },
        [2] = {coords = vector4(1121.34, -1563.12, 36.10, 0.00), taken = false, model = 256650529 },
