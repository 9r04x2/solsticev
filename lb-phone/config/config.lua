...
Config.Companies.Services = {
    {
        job = "police",
        name = "Los Santos Police Departman",
    ...
    {
        job = "vespuccipd",
        name = "Vinewoood Police Department",
        icon = "https://cdn-icons-png.flaticon.com/512/7211/7211100.png",
        canCall = true,
        canMessage = true,
        bossRanks = {"boss", "lieutenant"},
...
Config.EmailDomain = "solsticev.net"
...
Config.DynamicWebRTC.Enabled = true -- enable dynamic WebRTC? (this will allow you to generate new WebRTC credentials for each user)
