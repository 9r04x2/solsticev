...
Config.Lang = {
    -- Bildirimler
    Notification = {
        OccupiedSit = "Bu koltuk zaten dolu!",
        OccupiedLay = "Buraya uzanamazsınız!",
        NoAvailable = "Uygun bir koltuk yok!",
        NoFound = "Koltuk bulunamadı!",
        NoBedFound = "Uzanabileceğiniz bir şey bulunamadı!",
        TooTilted = "Bu koltuk çok eğimli!",
        CannotReachSeat = "Bu koltuğa ulaşamıyorsunuz!",
        CannotSitInSeat = "Bu koltuğa oturamazsınız!",
        CannotReachBed = "Bu yatağa/sehpaya ulaşamıyorsunuz!",
        AlreadyAttemptingToSit = "Zaten oturmaya çalışıyorsunuz!",
        AlreadyAttemptingToLay = "Zaten uzanmaya çalışıyorsunuz!"
    },

    -- Sohbet Önerileri
    ChatSuggestions = {
        Sit = "En yakın koltuğa otur",
        Lay = "En yakın yatak/sehpaya uzan"
    },

    -- Tuş Atama
    KeyMapping = {
        -- %s basmaları gereken tuşla otomatik olarak değiştirilir.
        SitDown = "Oturmak için %s tuşuna basın",
        LayDown = "Uzanmak için %s tuşuna basın",
        GetUp = "Kalkmak için %s tuşuna basın"
    },

    -- Ayarlar>Tuştakımları>Fivem açıklaması
    KeyBindingDesc = {
        Keyboard = {
            SitDown = "Otur - Otur (Koltuk)",
            LayDown = "Otur - Uzan (Yatak/Sehpa)",
            GetUp = "Otur - Kalk"
        },
        PadAnalog = {
            SitDown = "Otur - Otur (Koltuk) - Kumanda",
            LayDown = "Otur - Uzan (Yatak/Sehpa) - Kumanda",
            GetUp = "Otur - Kalk - Kumanda"
        }
    }
}
