...
local function createAndAttachProp(prop, ped)
    ...
    AttachEntityToEntity(propEntity, ped, boneIndex, prop.coords.x, prop.coords.y, prop.coords.z, prop.rotation.x, prop.rotation.y, prop.rotation.z, true, true, false, true, 0, true)
    return netId
end
    ...
    if (not isPlayerDead or action.useWhileDead) and not isDoingAction then
        ...
        CreateThread(function()
            ...
            while isDoingAction do
                ...
                if IsControlJustPressed(0, 252) and action.canCancel then
...
exports('OpenProgressbar', function()   
    return isDoingAction
end)