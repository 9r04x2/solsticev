...
Config.FiveGuard = 'ezgimm' -- Your fiveguard script name if exists, if not false.
...
Config.Garage = 'jg-advancedgarages'
...
Config.Society = 'qb-management' -- select you society: ('none','esx_society','ap-government','esx_society','qb-management','qb-banking','qs-banking','renewed-banking','okokbanking','zpx-banking')
...
Config.OpenHouseMenu = 'F11'                   -- Key to open the internal menu of the home
Config.OpenJobMenu = 'F10'                     -- Key to open the house creation menu
...
Config.EnableRaid = false               -- Enable or disable the usable item to initiate raids
...
Config.HireRenterCommand = 'kiraliklar'        -- Command for the administrator to expel a tenant from the property (force eviction)
...
ActionControls = {
	...
	undo_point = {
		label = 'Sonuncuyu Geri Al',
		codes = { 25 }
	},
	set_position = {
		label = 'Pozisyonu Ayarla',
		codes = { 24 }
	},
	add_garage = {
		label = 'Garaj Ekle',
