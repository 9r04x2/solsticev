...
Config.Activities = {
    ["workout"] = {
        label = "Egzersiz", -- Will have Start / Stop in front of interaction.
        sections = { -- Sections for this activity.
            ["lift"] = {
                label = "Ağırlık Kaldırma",
...
Config.Alerts = function(index, disabled)
    ...
    if (not disabled) then
        ShowNotification("Hapishane sireni " .. prison.label .. "!")
    else
        ShowNotification("Hapishane sireni " .. prison.label .. ".")
    end
end
...
Config.Prisons = {
    ["default"] = { -- Default is used as the prison location for players when not defined otherwise.
        label = "Boilingbroke Hapishanesi", -- Prison label for notifications & texts.
        ...
        stores = {
            {
                ...
                catalog = {
                    {
                        name = "cay",
                        description = "Şekerlimi Şekersizmi?",
                        amount = 1,
                        required = {
