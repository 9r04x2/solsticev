...
Config.trucker_locations = {
	["trucker_1"] = {															-- ID
		...
		['blips'] = {							-- Create the blips on map
			...
			['name'] = "Kamyon Lojistiği",		-- Blip Name
			['color'] = 4,						-- Blip Color
...
Config.jobs = {
	...
	['price_per_km_min'] = 250,				-- Minimum price per kilometer of the contract
	['price_per_km_max'] = 750,				-- Maximum price per kilometer of the contract
	...
	['available_loads'] = {
		...
		{ trailer = "armytanker", name = "Ordu yakıt tankı", def = {3,0,0}},
		{ trailer = "armytanker", name = "Ordu su temini", def = {0,0,0}},
		{ trailer = "armytanker", name = "Ordu aşındırıcı maddeler tankı", def = {6,0,1}},
		{ trailer = "armytanker", name = "Ordu yanıcı gaz tankı", def = {2,0,0}},
		{ trailer = "armytanker", name = "Ordu zehirli gaz tankı", def = {5,0,0}},
		{ trailer = "armytanker", name = "Ordu gizli malzemeleri", def = {0,0,1}},
		
		{ trailer = "docktrailer", name = "Mobilya taşımacılığı", def = {0,0,0}},
		{ trailer = "docktrailer", name = "Buzdolabı taşımacılığı", def = {0,1,0}},
		{ trailer = "docktrailer", name = "Tuğla taşımacılığı", def = {0,0,0}},
		{ trailer = "docktrailer", name = "İthal ürünlerin taşınması", def = {0,0,1}},
		{ trailer = "docktrailer", name = "Plastiklerin taşınması", def = {0,0,0}},
		{ trailer = "docktrailer", name = "Giysi taşımacılığı", def = {0,0,0}},
		{ trailer = "docktrailer", name = "Sandalye taşımacılığı", def = {0,0,0}},
		{ trailer = "docktrailer", name = "Alet taşımacılığı", def = {0,0,0}},
		{ trailer = "docktrailer", name = "Temizlik malzemelerinin taşınması", def = {0,0,0}},
		{ trailer = "docktrailer", name = "İşlenmiş kereste taşımacılığı", def = {0,0,0}},
		{ trailer = "docktrailer", name = "Taş taşımacılığı", def = {0,0,0}},
		{ trailer = "docktrailer", name = "Mücevherlerin taşınması", def = {0,1,1}},
		{ trailer = "docktrailer", name = "Cam taşımacılığı", def = {0,1,0}},
		{ trailer = "docktrailer", name = "Mühimmat taşımacılığı", def = {1,0,0}},
		
		
		{ trailer = "trailers4", name = "Denizcilik malzemeleri römorku", def = {0,0,0}},
		{ trailer = "trailers4", name = "Bot römorku", def = {0,1,1}},

		
		{ trailer = "tanker", name = "Katkı maddeleri içeren yakıt tankı", def = {3,0,0}},
		{ trailer = "tanker2", name = "Ortak yakıt tankı", def = {3,0,0}},
		{ trailer = "tanker2", name = "Kerosen tankı", def = {3,0,0}},
		{ trailer = "tanker2", name = "Yağ tankı", def = {3,0,0}},
		
		{ trailer = "docktrailer", name = "Egzotik malzemelerin taşınması", def = {0,1,1}},
		{ trailer = "docktrailer", name = "Nadir malzemelerin taşınması", def = {0,1,1}},
		{ trailer = "docktrailer", name = "Silahların taşınması", def = {0,0,1}},
		
		{ trailer = "trailerlogs", name = "Ağaç kütüğü taşımacılığı", def = {0,0,0}},
		
		{ trailer = "trailers", name = "İnşaat malzemelerinin taşınması", def = {0,0,0}},
		{ trailer = "trailers", name = "Kauçuk taşımacılığı", def = {0,0,0}},
		{ trailer = "trailers", name = "Alet taşımacılığı", def = {0,1,0}},
		{ trailer = "trailers", name = "Aşıların taşınması", def = {0,1,0}},
		{ trailer = "trailers", name = "Patlayıcıların taşınması", def = {1,1,0}},
		{ trailer = "trailers", name = "Talaş taşımacılığı", def = {0,0,0}},
		
		{ trailer = "trailers2", name = "Üzüm taşımacılığı", def = {0,0,0}},
		{ trailer = "trailers2", name = "Domuz eti taşımacılığı", def = {0,0,0}},
		{ trailer = "trailers2", name = "Sığır eti taşımacılığı", def = {0,0,0}},
		{ trailer = "trailers2", name = "Havuç taşımacılığı", def = {0,0,0}},
		{ trailer = "trailers2", name = "Patates taşımacılığı", def = {0,0,0}},
		{ trailer = "trailers2", name = "Süt taşımacılığı", def = {0,0,0}},
		{ trailer = "trailers2", name = "Konserve gıda taşımacılığı", def = {0,0,0}},
		{ trailer = "trailers2", name = "Donmuş et taşımacılığı", def = {0,0,0}},
		{ trailer = "trailers2", name = "Fasulye taşımacılığı", def = {0,0,0}},
		{ trailer = "trailers2", name = "Sirke taşımacılığı", def = {0,0,0}},
		{ trailer = "trailers2", name = "Limonata taşımacılığı", def = {0,0,0}},
		{ trailer = "trailers2", name = "Şişelenmiş su taşımacılığı", def = {0,0,0}},
		{ trailer = "trailers2", name = "Peynir taşımacılığı", def = {0,0,0}},
		
		{ trailer = "trailers3", name = "Karo taşımacılığı", def = {0,0,0}},
		{ trailer = "trailers3", name = "Demir yolu taşımacılığı", def = {0,0,0}},
		{ trailer = "trailers3", name = "Kullanılmış ambalaj taşımacılığı", def = {0,0,0}},
		{ trailer = "trailers3", name = "Zemin plakası taşımacılığı", def = {0,0,0}},
		{ trailer = "trailers3", name = "Seramik taşımacılığı", def = {0,1,0}},
		{ trailer = "trailers3", name = "Atık taşımacılığı", def = {0,0,0}},
		
		{ trailer = "trailers4", name = "Havai fişeklerin taşınması", def = {1,1,0}},
		{ trailer = "trailers4", name = "Patlayıcıların taşınması", def = {1,1,0}},
		{ trailer = "trailers4", name = "Dinamitle taşımacılık", def = {1,1,0}},
		{ trailer = "trailers4", name = "Beyaz fosfor taşımacılığı", def = {4,1,0}},
		{ trailer = "armytanker", name = "Ordu yakıt tankı", def = {3,0,0}},
		{ trailer = "armytanker", name = "Ordu su temini", def = {0,0,0}},
		{ trailer = "armytanker", name = "Ordu aşındırıcı maddeler tankı", def = {6,0,1}},
		{ trailer = "armytanker", name = "Ordu yanıcı gaz tankı", def = {2,0,0}},
		...
		{ trailer = "trailers", name = "Inşaat malzemelerinin taşınması", def = {0,0,0}},
		{ trailer = "trailers", name = "Kauçuk taşımacılığı", def = {0,1,0}},
		{ trailer = "trailers", name = "Aşıların taşınması", def = {0,1,0}},
		{ trailer = "trailers", name = "Patlayıcıların taşınması", def = {1,1,0}},
		{ trailer = "trailers", name = "Talaş taşımacılığı", def = {0,0,0}},
...
Config.drivers = {
	...
	['hiring_costs'] = {						-- Cost of hiring the driver (this amount will only be paid at the time of hiring)
		['min'] = 75,							-- This is the minimum base cost of hiring the employee
		['max'] = 125,							-- This is the maximum base cost of hiring the employee (this amount will increase according to the employee's skills)
...
Config.driver_jobs = {
	...
	['profit'] = {								-- These are the drivers' earnings for each contract, a random value is generated for each contract
		['min'] = 20,							-- Minimum base profit, this will be the minimum money this driver can generate
		['max'] = 35,							-- Maximum base profit, this will be the maximum amount of money this driver can generate (this amount will increase according to the driver's skills)
...
Config.loans = {
	...
	['plans'] = {
		{
			['loan_amount'] = 2000,		-- Total loan amount (20,000)
