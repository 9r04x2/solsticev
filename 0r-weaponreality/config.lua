...
Config.PickUpMenu = "drawtext" -- drawtext, textui

Config.TextUI = "qb-textui" -- qb-textui, ox-textui
...
Config.Inventory = "qb-inventory" -- qb-inventory, ox-inventory, lj-inventory, qs-inventory, esx-inventory
...
Config.Notifications = {
    ['tookweaponfromground'] = { message = "You took weapon from ground."},
    ...
    ['tooLongDistance'] = { message = "You can't throw your gun that far."},
    ['NoWeapon'] = { message = "You can't throw a gun when you don't have one in your hand."},
    ['weaponThrown'] = { message = "You successfully threw your weapon."},
    ['checkSpotsAdmin'] = { message = "The coordinates of the weapon throwing spots are in the server console."},
    ['changedAnimationsAlways'] = {message = "Weapon animation is always active > config.lua 7th line"},
    ['shoulderSwapDisabled'] = {message = "This feature is closed. If u want to open it check > config.lua 11th line"}
}