...
Config.WhitelistedJobs = { 'police','lssp','bcsd','pbsd','lspr','dsd','vespuccipd','doj' } -- jobs allowed to open the mdt
...
Config.Locale = 'tr-TR' -- en-US, es-ES, de-DE, ro-RO, etc.. (from Config.Locales)
...
Config.Dispatch = {}
Config.Dispatch.Script = 'ps-dispatch' -- redutzu-mdt dispatch
...
Config.Dispatch.UseNotificaionSounds = false -- Will play a sound when you recieve a new call
...
-- Dispatch features
Config.Dispatch.Speeding = false
Config.Dispatch.Shooting = false
Config.Dispatch.CarJacking = false
Config.Dispatch.PlayerDead = false
Config.Dispatch.Explosion = false
Config.Dispatch.Combat = false
Config.Dispatch.DriveBy = false

-- Dispatch map
Config.Dispatch.Map = {}
Config.Dispatch.Map.Officers = false -- Show officers on the map
Config.Dispatch.Map.OnlyShowDutyOfficers = false -- Only show officers on the map when on duty
