...
Config['PetsSettings'] = {
    ['framework'] = {
        name = 'QB', -- Only ESX, QB or STANDALONE.
    ...
    ['menuCommand'] = 'oyuncak', -- Open pet settings menu command (/pet)
    ...
    ['locales'] = {
        ['en'] = {
            ...
            ['left'] = 'Sol',
            ['right'] = 'Sağ',
            ['cooldown'] = 'Bekleme süresini beklemelisiniz',
            ['no_pet'] = 'Evcil hayvanınız yok',
            ['already_have'] = 'Zaten evcil hayvanınız var'
        },
        ['test'] = {
            ['refresh'] = 'RefreshX',
            ['effect'] = 'EffectX',
