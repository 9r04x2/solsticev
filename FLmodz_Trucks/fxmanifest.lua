...
data_file 'HANDLING_FILE' 'data/blacktop_handling.meta'
data_file 'VEHICLE_METADATA_FILE' 'data/blacktop_vehicles.meta'
data_file 'VEHICLE_VARIATION_FILE' 'data/blacktop_carvariations.meta'
data_file 'DLC_TEXT_FILE' 'data/blacktop_dlctext.meta'
