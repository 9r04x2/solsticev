...
Config.TelevisionWebhook = false -- enable this if you want use webhooks (you need configure your webhook in other.lua file!)
...
Config.TelevisionPresets = false -- enable this feature if you want to have, for example, a web page running on a screen at a given coordinates without adding it from the player, you can enable this feature and add screens with links in Config.TelevisionPresetsLocations
...
Config.VehicleTelevisionoForOnlySpecifiedTypeOfVehicle = true --- if you enable this, television will work only for specified vehicle (Vehicle Class) you need enable class in Config.TelevisonVehiclesClasses
...
Config.TelevisionObjects = {
	...
	{
		object = "uwu_prop_x17_tv_scrn_01", --object name
		maxdistance = 40.0, --max distance for display screen
		maxcontroldistance = 20.0, -- max distance for control tv (its cannot be higher than maxdistance)
		rendertarget = true, -- enable render target
		rendertargetname = "tvscreen", -- render target name
	},
	{
		...
		maxdistance = 30.0, --max distance for display screen
		maxcontroldistance = 5.0, -- max distance for control tv (its cannot be higher than maxdistance)
		rendertarget = true, -- enable render target 
		rendertargetname = "tvscreen", -- render target name
	},
	{
	...
	{
        object = "prop_flatscreen_overlay", --object name 
        maxdistance = 45.0, --max distance for display screen
        maxcontroldistance = 15.0, -- max distance for control tv (its cannot be higher than maxdistance)
        rendertarget = true, -- enable render target 
        rendertargetname = "tvscreen", -- render target name
    },
...
Config.TelevisionObjectsLocations = { -- You need enable Config.TelevisionObjectPlacer for use this
	{
		...
		coords = vector3(-570.13592529297,-1071.0606689453,23.317134857178), -- object coordsvec3(-570.13592529297,-1071.0606689453,23.317134857178)
		rotation = vector3(-570.13592529297,-1071.0606689453,23.317134857178), -- object coords
		handler = nil,
	},
}

Config.TelevisionPresetsLocations = { -- You need enable Config.TelevisionPresets for use this
	{
		coords = vector3(-570.66516113281,-1071.0606689453,24.009250640869), -- screen coords
		url = "https://rtx.tebex.io", -- url which will be projected
	},
}

Config.TelevisionPermissionsLocations = { -- You need enable Config.TelevisionPermissions for use this
	{
		coords = vector3(-570.66516113281,-1071.0606689453,24.009250640869), -- tv coords vec3(-570.66516113281,-1071.0606689453,24.009250640869)
