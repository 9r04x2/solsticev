...
Config.OnePercentWorth = 80           -- Means that 1% progress will reward players with $100
...
Config.Blips = { -- Here you can configure Company blip.
    [1] = {
        ...
        Color = 69,
        Scale = 0.8,
        Pos = vector3(-97.32, -1013.78, 27.28),
        Label = 'İnşaatcı'
    },
}
...
Config.SpawnPoint = vector4(-86.18, -1022.00, 27.63, 250.47)      -- Company car spawn point
Config.MixerSpawnPoint = vector4(-86.18, -1022.00, 27.63, 250.47)  -- Company Mixer Spawn Point
...
Config.Lang = {
    ...
    -- Client
    ["no_permission"] = "Bu işlemi yalnızca ekip lideri yapabilir!",
    ["keybind"] = 'İnşaat İşi İşaretleyici Etkileşimi',
    ["too_far"] = "Ekibiniz işi başlattı, ancak merkezden çok uzaktasınız",
    ["kicked"] = "%s kişisini ekipten çıkardınız",
    ["alreadyWorking"] = "Önceki işi tamamlayın",
    ...
    ["spawnpointOccupied"] = "Araç veya mikser kamyonu çıkış noktası meşgul",
    ["pipesNotReady"] = "Beton dökmeden önce boruları kurmalısınız",
    ["clickToPour"] = "~INPUT_CONTEXT~ Beton dökmek için",
    ["installPipe"] = "Boru Kur",
    ["pickupBlock"] = "Blok Al",
    ["tutorialAfterMixerPickup"] = "Patronunuz tarafından tahsis edilen beton mikserini aldınız. İnşaat alanına gidin ve belirtilen alanlara beton dökün. İnşaat alanı GPS'te işaretlendi",
    ["startingTutorial"] = "İnşaatçı işine hoş geldiniz. Sahada kaynak yapmaktan duvar inşa etmeye, drenaj oluşturmaya veya beton dökmeye kadar çeşitli görevler sizi bekliyor. Bir grup halinde çalışıyorsanız, şimdi bölünmeniz gerekiyor, bir kişi beton mikseri alma noktasına bırakılmalı ve ardından beton mikseri inşaat alanına taşınmalı. Her bir aktiviteye ilk yaklaştığınızda açıklanacak. Görevlerin yerleri haritada işaretlendi. Tek başınıza çalışıyorsanız, her görevi kendiniz tamamlamanız gerekir, grup halinde çalışıyorsanız, nasıl bölüşeceğinize siz karar verirsiniz. Tüm görevleri yapmak zorunda değilsiniz, istediğiniz zaman bitirebilirsiniz ve ödemeniz yaptığınız görevlerin yüzdesine bağlıdır. İyi şanslar dileriz!",
    ["installBlock"] = "Duvar İnşa Et",
    ["tutorialWallBuilding"] = "Duvar çerçevesinin yanındasınız, göreviniz beton bloklar kullanarak duvar inşa etmek. Beton bloklar çerçevenin yanında ve GPS'te işaretlendi. Blok yığınına gidin, bir blok alın ve duvara monte edin",
    ["tutorialAboutPipes"] = "Kanalizasyon borularına bakan bir deliğin yanındasınız. Göreviniz boruları doğru yerlere kurmak. Boruları kurduktan sonra, beton mikseri kullanarak deliği betonla doldurmanız gerekiyor.",
    ["tutorialWelding"] = "Patronunuzun size kaynak yapmanızı söylediği yerin yanındasınız. İş çok basit, daha fazla açıklamaya gerek yok",
    ["startWelding"] = "Kaynak Yapmaya Başla",
    ["workstationOccupied"] = "Bu çalışma istasyonu meşgul",
    ["notFullJob"] = "Bir işi bitirmeden önce %100 ilerleme kaydetmelisiniz",
    ["notADriver"] = "İşi bitirmek için araç sürücüsü olmalısınız",
    ["partyIsFull"] = "Davet gönderilemedi, grubunuz dolu",
    ["wrongReward1"] = "Ödeme yüzdesi 0 ile 100 arasında olmalı",
    ["wrongReward2"] = "Tüm ödemelerin toplam yüzdesi 100'ü aştı",
    ["cantLeaveLobby"] = "Çalışırken lobiden ayrılamazsınız. Önce işi bitirin.",
    
    -- Server
    ["isAlreadyHost"] = "Bu oyuncu ekibini yönetiyor.",
    ["isBusy"] = "Bu oyuncu zaten başka bir ekibe ait.",
    ["hasActiveInvite"] = "Bu oyuncunun zaten başka birinden aktif daveti var.",
    ["HaveActiveInvite"] = "Zaten bir ekibe katılmak için aktif davetiniz var.",
    ["InviteDeclined"] = "Davetiniz reddedildi.",
    ["InviteAccepted"] = "Davetiniz kabul edildi!",
    ["error"] = "Bir ekibe katılırken bir sorun oluştu. Lütfen daha sonra tekrar deneyin.",
    ["kickedOut"] = "Ekipten çıkarıldınız!",
    ["reward"] = "Ödeme olarak $ aldınız",
    ["RequireOneFriend"] = "Bu iş en az bir ekip üyesi gerektirir",
    ["penalty"] = "Cezai olarak şu miktarda para ödediniz: ",
    ["clientsPenalty"] = "Ekibin lideri cezayı kabul etti. Ödeme almadınız",
    ["noMixerStatus"] = "Şu anda sizin için uygun bir beton mikserimiz yok. Lütfen daha sonra tekrar deneyin",
    ["dontHaveReqItem"] = "Siz veya ekibinizden biri işi başlatmak için gerekli eşyaya sahip değil",
    ["notEverybodyHasRequiredJob"] = "Arkadaşlarınızdan her biri gerekli işe sahip değil",
    ["someoneIsOnCooldown"] = "%s şu anda işi başlatamıyor (bekleme süresi: %s)",
    ["hours"] = "sa",
    ["minutes"] = "dk",
    ["seconds"] = "sn",
    ["newBoss"] = "Önceki ekip lideri sunucudan ayrıldı. Artık siz ekip liderisiniz",
    ["wait"] = "Lütfen birkaç saniye bekleyin ve daha sonra tekrar deneyin"    
}
Config.JobBlipsStyle = {
    ["mixerSpawnLocation"] = {
        color = 47,
        string = "~o~[BUILDER]~s~ Kamyonet için beton mikseri",
        sprite = 800,
    },
    ["mixerTargetLocation"] = {
        color = 47,
        string = "~o~[BUILDER]~s~ Beton Mikseri Teslimat Yeri",
        sprite = 652,
    },
    ["installPipe"] = {
        color = 47,
        string = "[BUILDER] Boruyu takın",
        sprite = nil,
    },
    ["blockPickup"] = {
        color = 47,
        string = "~o~[BUILDER]~s~ Duvar yapımı için Pickup Blokları",
        sprite = 655, 
    },
    ["buildWall"] = {
        color = 47,
        string = "~o~[BUILDER]~s~ Bir duvar inşa et",
        sprite = 285, 
    },

    ["welding"] = {
        color = 47,
        string = "~o~[BUILDER]~s~ Kaynak",
        sprite = 468, 
    },
}
