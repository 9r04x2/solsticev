...
Config.ped = {
    ...
    ---@type ShopBuyItem[]
    buyItems = {
        { name = 'angle_grinder', description = locale('angle_grinder_description'), price = { money = 1000, crypto = 75 }, stock = 50 },
        { name = 'plasma_cutter', description = locale('plasma_cutter_description'), price = { money = 1000, crypto = 75 }, stock = 50 },
        { name = 'hack_usb', description = locale('hack_usb_description'), price = { money = 1250, crypto = 100 }, stock = 50 },
        { name = 'hack_card', description = locale('hack_card_description'), price = { money = 2000, crypto = 150 }, stock = 50 },
        { name = 'thermite', description = locale('thermite_description'), price = { money = 250, crypto = 20 }, stock = 50 },
        { name = 'large_drill', description = locale('large_drill_description'), price = { money = 5000, crypto = 200 }, stock = 50 },
        { name = 'small_drill', description = locale('small_drill_description'), price = { money = 5000, crypto = 200 }, stock = 50 },
        { name = 'explosives', description = locale('explosives_description'), price = { money = 5000, crypto = 200 }, stock = 50 },
        { name = 'weapon_digiscanner', description = locale('signal_booster_description'), price = { money = 2500, crypto = 125 }, stock = 50 },
        { name = 'bomb_c4', description = locale('bomb_c4_description'), price = { money = 7500, crypto = 200 }, stock = 50 },
    ...
    ---@type ShopSellItem[]
    sellItems = {
        { name = 'gold_bar', price = { money = 7500, crypto = 25 } },
        { name = 'classified_docs', price = { money = 3500, crypto = 25 } },
        { name = 'rare_coins', price = { money = 5250, crypto = 25 } },
        { name = 'diamonds_box', price = { money = 19500, crypto = 25 } },
        { name = 'diamond_necklace', price = { money = 12500, crypto = 25 } },
        { name = 'diamond_ring', price = { money = 7500, crypto = 25 } },
        { name = 'luxurious_watch', price = { money = 11500, crypto = 25 } },
        { name = 'painting', price = { money = 20000, crypto = 25 } },
        { name = 'rare_tequila', price = { money = 50000, crypto = 35 } },
        { name = 'pink_diamond', price = { money = 100000, crypto = 30 } },
        { name = 'coke_brick', price = { money = 3000, crypto = 25 } },
        { name = 'weed_brick', price = { money = 1500, crypto = 25 } },
        { name = 'tv', price = { money = 2500, crypto = 25 } },
        { name = 'microwave', price = { money = 1500, crypto = 25 } },
        { name = 'monitor', price = { money = 1250, crypto = 25 } },
        { name = 'printer', price = { money = 2000, crypto = 25 } },
        { name = 'flat_tv', price = { money = 3000, crypto = 25 } },
        { name = 'old_tv', price = { money = 2000, crypto = 25 } },
        { name = 'dj_deck', price = { money = 1750, crypto = 25 } },
        { name = 'console', price = { money = 1000, crypto = 25 } },
        { name = 'keyboard', price = { money = 250, crypto = 25 } },
        { name = 'laptop', price = { money = 1250, crypto = 25 } },
        { name = 'bong', price = { money = 500, crypto = 25 } },
        { name = 'meth_bag', price = { money = 2500, crypto = 25 } }
    },
    ---@type vector4[]
    locations = {
