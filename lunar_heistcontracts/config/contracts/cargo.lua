Config.contracts.cargo = {
    ...
    guards = {
        ...
        weapons = {
            { name = 'weapon_glock19gen4', ammo = { name = 'pistol_ammo', min = 1, max = 1 } }
        },
    },
        ...
        types = {
            {
                ...
                items = {
                    { name = 'weapon_glock19gen4', count = 1 },
                    { name = 'weapon_knife', count = 1 },
                    { name = 'pistol_ammo', count = { min = 4, max = 15 } },
                    { name = 'money', count = { min = 7200, max = 25000 } },
