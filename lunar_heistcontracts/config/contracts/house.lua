Config.contracts.house = {
    ...
    tiers = {
        ['low'] = {
            ...
            reward = { crypto = 5, experience = 100 }
        },
        ['medium'] = {
            ...
            chance = 30,
            requiredExperience = 0,
            reward = { crypto = 8, experience = 150 }
        },
        ['high'] = {
            ...
            chance = 12,
            requiredExperience = 0,
            reward = { crypto = 10, experience = 200 }
        },
        ['high2'] = {
            label = locale('house_tier_high'),
            image = './contracts/house_high.jpg',
            ...
            chance = 12,
            requiredExperience = 0,
            reward = { crypto = 12, experience = 200 }
        },
        ['mafia'] = {
            ...
            chance = 2,
            requiredExperience = 0,
            reward = { crypto = 15, experience = 250 }
        },
        ['celebrity'] = {
            ...
            chance = 2,
            requiredExperience = 0,
            reward = { crypto = 20, experience = 250 }
        },
    },
    ...
    interiors = {
        ...
        ['celebrity'] = {
            ...
            guards = {
                ...
                ---@type GuardWeapon[]
                weapons = {
                    -- { name = 'weapon_dp9', ammo = { name = 'ammo-9', min = 60, max = 180 } },
                },
                locations = {
                    vector4(-167.1931, 495.4595, 137.6535, 103.6151),
                    vector4(-167.4547, 484.9008, 137.2444, 23.0632),
