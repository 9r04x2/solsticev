Config.contracts.pacific = {
    ...
    basement = {
        ...
        guards = {
            ...
            ---@type GuardWeapon[]
            weapons = {
                -- { name = 'weapon_tp9', ammo = { name = 'pistol_ammo', min = 60, max = 180 } },
                -- { name = 'weapon_glock19', ammo = { name = 'pistol_ammo', min = 60, max = 180 } },
            },
        },
        props = {
        ...
        loot = {
            rewards = {
                ['cash'] = { account = 'money', count = { pile = 120000, trolley = 250000 } },
