...
RegisterNetEvent('brazzers-fakeplates:client:usePlate', function(plate)
    ...
    if dist <= 5.0 then
        ...
        QBCore.Functions.Progressbar("attaching_plate", "Plaka Takılıyor", 4000, false, true, {
...
RegisterNetEvent('brazzers-fakeplates:client:removePlate', function()
    ...
    if dist <= 5.0 then
        ...
        TaskTurnPedToFaceEntity(ped, vehicle, 3.0)
        QBCore.Functions.Progressbar("removing_plate", "Plaka Kaldırılıyor", 4000, false, true, {
            disableMovement = true,
            disableCarMovement = true,
            disableMouse = false,
            disableCombat = true,
