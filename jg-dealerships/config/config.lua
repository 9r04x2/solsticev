...
-- Localisation
Config.Locale = "tr"
Config.NumberAndDateFormat = "tr-TR"
Config.Currency = "USD"
...
-- Text UI prompts
Config.OpenShowroomPrompt = "[E] Showroom'u Aç"
Config.OpenShowroomKeyBind = 38
Config.ViewInShowroomPrompt = "[E] Showroom'da Görüntüle"
Config.ViewInShowroomKeyBind = 38
Config.OpenManagementPrompt = "[E] Bayi Yönetimi"
Config.OpenManagementKeyBind = 38
Config.SellVehiclePrompt = "[E] Araç Sat"
...
-- Test drives
Config.TestDrivePlate = "Test" -- This is a plate seed so it'll be random every time (read: https://docs.jgscripts.com/dealerships/plate-format)
...
Config.DealershipLocations = {
  ["pdm"] = {
    ...
    categories = {"sedans", "compacts", "motorcycles", "offroad", "coupes", "muscle", "sports", "super", "suvs", "sportsclassics","mk2"},
