...
Config.Mods.ItemsRequired = {
  ...
  performance = { itemName = "performance_part", removeItem = false },
  cosmetics = { itemName = "cosmetic_part", removeItem = false },
  stance = { itemName = "stancing_kit", removeItem = false },
  respray = { itemName = "respray_kit", removeItem = false },
  wheels = { itemName = "vehicle_wheels", removeItem = false },
  neonLights = { itemName = "lighting_controller", removeItem = false },
  headlights = { itemName = "lighting_controller", removeItem = false },
  tyreSmoke = { itemName = "tyre_smoke_kit", removeItem = false },
  bulletproofTyres = { itemName = "bulletproof_tyres", removeItem = true },
  extras = { itemName = "extras_kit", removeItem = false }
}
