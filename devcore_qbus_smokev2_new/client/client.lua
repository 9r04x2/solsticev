...
AddEventHandler('devcore_smokev2:client:Smoke', function(item, size, armor, stress, prop, type, time)
	if StartSmoke == true then
		exports['ZSX_UIV2']:Notification("Hata", Languages[Config.Language]['already_smoke'], "fas fa-times-circle", 5000)
			...
			if not give and IsControlJustPressed(0, Config.SmokeButton) then
				if multiplier >= 0.9009426647617 then
					if type == 'joint' or type == 'bong' then
						exports['ZSX_UIV2']:Notification("Hata", Languages[Config.Language]['enough'], "fas fa-times-circle", 5000)
				...
				if type == 'bong' or type == 'vape' then
					if size < 0.5 then
						size = 0
						exports['ZSX_UIV2']:Notification("Hata", Languages[Config.Language]['empty'], "fas fa-times-circle", 5000)
			...
			elseif not give and hand and IsControlJustPressed(0, Config.MouthButton) then
				if type == 'vape' then
					if size >= Config.MaxLiquid then
						exports['ZSX_UIV2']:Notification("Hata", Languages[Config.Language]['nospace'], "fas fa-times-circle", 5000)
