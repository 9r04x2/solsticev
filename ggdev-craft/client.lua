...
function StartCrafting(itemName, itemData, amount)
    ...
    QBCore.Functions.TriggerCallback('ggdev-craft:server:checkmaterials', function(hasMaterials)
        if hasMaterials then
            QBCore.Functions.Progressbar("crafting", Locales("crafting_in_progress"), amount * itemData.time, false, true, {
                ...
                TriggerServerEvent('ggdev-craft:server:giveitem', itemName, amount, itemData.requiredItems, coords)
