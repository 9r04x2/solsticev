...
function openCreateLobby() {
  tyx = "create";
  $(".create-lobby-dec").html("Leave Blank if you want to open without password.")
  $(".create-button").html("CREATE LOBBY")
  $.post("https://BakiTelli_paintball/addname");
}
function LoginLobby(name) {
  tyx = "login";
  $(".create-lobby-dec").html("Please note that passwords consist only of numbers..")
  $(".create-button").html("LOGIN LOBBY")
  $(".Create-Password").val("");
  $.post(
