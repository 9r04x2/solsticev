...
Config.Namep = "SOLSICE" -- LobbyName Prefix
...
Config.GameFinishRevive = false -- Finish Game Revive ?
Config.Markers = {
	PaintBall = {
		Type = 21,
		Size = {
...
Config.PaintballArea = {
	{
		AreaCoord = vector3(-1675.64, 264.78, 62.39)
	},
}

Config.Langs = {
	OpenMenu = "[E] - PaintBall Menüsünü Açın",
	BlipName = "PaintBall Arena",
	LobbyCoolDown = "O kadar hızlı lobi yapamazsın, sadece bekle."
}