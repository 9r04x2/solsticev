...
Config.CostMultiplier = 0.2 -- Amount to multiply 1 by. This indicates fuel price. (Default: $3.0/l or 3.0)
...
Config.EmergencyServicesDiscount = {
    ...
    ['discount'] = 70, -- % Discount off of price.
...
Config.StationFuelSalePercentage = 0.85 -- % of sales that the station gets. If they sell 4 Liters of Gas for $16 (not including taxes), they will get 16*Config.StationFuelSalePercentage back from the sale. Treat this as tax, also, it balances the profit margins a bit.
...
Config.MaxFuelReserves = 10000 -- This is the maximum amount that the fuel station's reserves can hold.
...
Config.AirAndWaterVehicleFueling = {
    ...
    ['locations'] = {
        ...
        [1] = {
            ...
            ['draw_text'] = "[G] Helikopter Yakıt İkmali",
            ['type'] = 'air',
            ['whitelist'] = {
                ['enabled'] = true,
                ['on_duty_only'] = true,
...
Config.GasStations = { -- Configuration options for various gas station related things, including peds, coords and labels.
    ...
    [29] = {
        ...
        cost = 2000000, -- This is the cost of the gas station for someone purchasing it, not including tax.
