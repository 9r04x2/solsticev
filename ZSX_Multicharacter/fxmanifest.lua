...
shared_scripts {'shared/functions/sh_fn.lua', 'shared/config.lua', 'shared/config_locations.lua', 'shared/config_framework.lua', 'shared/config_usersettings.lua', 'shared/translations.lua'}
