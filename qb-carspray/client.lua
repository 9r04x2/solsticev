...
RegisterNetEvent('sy-carspray:client:usedSpray', function(i)
...
function applyPaint(veh, i)
    ...
    DeleteEntity(sprayProp)
    FreezeEntityPosition(veh, false)
    TriggerServerEvent('sy-carspray:client:finishedSpray', QBCore.Functions.GetVehicleProperties(veh), i)
end